-- ============================================================
-- scripts/sql/seed_test_data.sql
...
-- ============================================================
-- DONNÉES DE TEST (VERSION CORRIGÉE AVEC CAST)
-- ============================================================
...
-- Vérifier avec CAST (correction collation)
SELECT 
    c.id,
    c.name,
    rc.report_frequency,
...
LEFT JOIN report_configs rc 
    ON CAST(c.id AS CHAR CHARACTER SET utf8mb4) COLLATE utf8mb4_unicode_520_ci = 
       CAST(rc.company_id AS CHAR CHARACTER SET utf8mb4) COLLATE utf8mb4_unicode_520_ci
WHERE c.id IN (
    '01hjt9qsj7b039ww1nyrn9kg5t',
    '01hjpwjzgwr3y0d62wywg6z1pp',
    '01hpz90v5y7s26taq1jq633zdt'
